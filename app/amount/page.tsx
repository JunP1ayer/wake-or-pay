        ...
        <div className="bg-white rounded-xl shadow-lg p-6">
          ...
          <div className="space-y-6">
            ...
            <div className="text-center">
              ...
              <div className="flex items-center justify-center gap-2 p-6 bg-green-50 border-2 border-green-200 rounded-lg">
                <div className="text-center">
                  <div className="text-5xl font-bold text-green-700 mb-1">¥100</div>
                  <div className="text-lg text-green-600">≈ $1 USD</div>
                </div>
              </div>
            ...
            <button
              ...
              disabled={isLoading}
              className="w-full flex items-center justify-center gap-2 px-6 py-4 bg-green-600 text-white rounded-lg hover:bg-green-700 disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-200 font-medium text-lg"
            >
              {isLoading ? (
                <>
